...
const usernameRegister = document.querySelector("#username_signin");
const usernameRegisterError = document.querySelector("#username_signinError");
const passwordRegister = document.querySelector("#password_signin");
