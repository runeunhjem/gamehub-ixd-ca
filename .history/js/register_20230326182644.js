...
emailRegister.addEventListener("focus", function () {
  emailRegister.placeholder = "Repeat your wanted password";
});
emailRegister.addEventListener("blur", function () {
  emailRegister.placeholder = "Repeat Password";
});
...
function validateForm(event) {
  ...
  if (formSubmitted) {
    ...
    if (checkLength(emailRegister.value, 3)) {
      emailRegisterRegisterError.style.display = "none";
      emailRegisterRegister.style.backgroundColor = "#8fff98";
      emailRegisterRegister.style.color = "#000000";
    } else {
      emailRegisterRegisterError.style.display = "block";
      emailRegisterRegister.style.backgroundColor = "#fafad2";
      emailRegisterRegister.style.color = "#FF0000";
    }
    if (
